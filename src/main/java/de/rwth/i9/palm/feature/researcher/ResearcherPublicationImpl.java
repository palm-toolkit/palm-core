...
public class ResearcherPublicationImpl implements ResearcherPublication
{
	...
	public Map<String, Object> getPublicationListByAuthorIdAndTopic( String authorId, String topics, String query, String year, Integer startPage, Integer maxresult, String orderBy )
	{
		// create JSON mapper for response
		Map<String, Object> responseMap = new LinkedHashMap<String, Object>();
