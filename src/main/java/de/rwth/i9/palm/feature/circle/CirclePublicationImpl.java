...
public class CirclePublicationImpl implements CirclePublication
{
	...
	@Override
	public Map<String, Object> getCircleMemberPublication( String circleId, String author_id, String query, String year, Integer startPage, Integer maxresult, String orderBy )
	{
		// create JSON mapper for response
		Map<String, Object> responseMap = new LinkedHashMap<String, Object>();
		...
		List<Publication> publications = null;
		// get publication list
		if ( !query.equals( "" ) || !year.equals( "all" ) || startPage != null || maxresult != null || memberCircle != null )
		{
			Map<String, Object> publicationsMap = persistenceStrategy.getPublicationDAO().getPublicationWithPaging( query, "all", targetCircle, memberCircle, startPage, maxresult, year, orderBy );
			publications = (List<Publication>) publicationsMap.get( "publications" );
		}
		else
		{
