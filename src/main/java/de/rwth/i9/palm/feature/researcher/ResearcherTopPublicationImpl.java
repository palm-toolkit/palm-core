	...
	public Map<String, Object> getTopPublicationListByAuthorId( String authorId, Integer startPage, Integer maxresult )
	{
		...
		for ( Publication publication : publications )
		{
			...
			if ( publication.getEvent() != null )
			{
				...
				if ( publication.getEvent().getEventGroup().getNotation() != null && !publication.getEvent().getEventGroup().getNotation().isEmpty() && !publication.getEvent().getEventGroup().getNotation().equals( publication.getEvent().getEventGroup().getName() ) )
