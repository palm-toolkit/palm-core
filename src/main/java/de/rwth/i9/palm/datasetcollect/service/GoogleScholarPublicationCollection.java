...
public class GoogleScholarPublicationCollection extends PublicationCollection
{
	...
	public static List<Map<String, String>> getListOfAuthors( String authorName ) throws IOException
	{
		...
		cookies.put( "GOOGLE_ABUSE_EXEMPTION", "ID=96722ad1df7b0edd:TM=1436732311:C=c:IP=176.199.94.165-:S=APGng0tMknCKQKH3VVCBTwU8ivyNr7kEXQ" );
		cookies.put( "GSP", "LM=1436732336:S=59qJGb7y6bfGH0Kv" );
		//cookies.put( "HSID", "AhDcQNKXGhrXqB3le" );
		cookies.put( "NID", "69=AXgidpek8Pt8MCeAOGSaIIXiyA_tt2w0tpDQK2eBWS6WFZxiUVqb4Q1SqJqYMRq2FWu299Awi9KdLrZnieBlLkUFgOAZcRyxIcTDvY9lK93hvze9ydtWgx-JN14wN15n" );
