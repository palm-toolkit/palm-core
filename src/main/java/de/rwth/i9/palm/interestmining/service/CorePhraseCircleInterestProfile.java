...
@Service
public class CorePhraseCircleInterestProfile
{
	private final static Logger log = LoggerFactory.getLogger( CorePhraseCircleInterestProfile.class );

	@Autowired
	private PersistenceStrategy persistenceStrategy;

	public void doCorePhraseCalculation( CircleInterest circleInterest, PublicationClusterHelper publicationCluster, Double yearFactor, Double totalYearFactor, int numberOfExtractionService )
	{
		...
		for ( Map.Entry<String, TermDetail> termDetailEntryMap : termDetailsMap.entrySet() )
		{
			...
			// Finally, put calculation into circleInterest object
