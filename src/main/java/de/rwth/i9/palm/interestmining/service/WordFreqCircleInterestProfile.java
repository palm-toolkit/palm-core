...
@Service
public class WordFreqCircleInterestProfile
{
	private final static Logger log = LoggerFactory.getLogger( WordFreqCircleInterestProfile.class );
	...
	public void doWordFreqCalculation( CircleInterest circleInterest, PublicationClusterHelper publicationCluster, Double yearFactor, Double totalYearFactor, int numberOfExtractionService )
	{
		...
		for ( Map.Entry<String, Double> termWeightHelperEntry : termWeightHelperMap.entrySet() )
		{
			...
			// process term to circle interest map
